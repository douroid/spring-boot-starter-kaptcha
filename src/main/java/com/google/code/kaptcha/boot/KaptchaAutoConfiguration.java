...
public class KaptchaAutoConfiguration {
    ...
    public ServletRegistrationBean kaptchaServlet(KaptchaProperties properties) {
        ...
        bean.addInitParameter(Constants.KAPTCHA_SESSION_CONFIG_KEY, properties.getSessionConfigKey());
        bean.addInitParameter(Constants.KAPTCHA_SESSION_CONFIG_DATE, properties.getSessionConfigDate());
